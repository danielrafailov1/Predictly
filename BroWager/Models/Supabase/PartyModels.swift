...
struct PartyInsertPayload: Codable {
    ...
    init(created_by: String, party_name: String, privacy_option: String, max_members: Int, bet: String, bet_date: String, bet_type: String, options: [String], terms: String, status: String, game_status: String, party_code: String, max_selections: Int) { // Added max_selections parameter
